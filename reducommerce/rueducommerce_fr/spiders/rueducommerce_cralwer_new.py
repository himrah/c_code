...
class RueducommerceSpider(scrapy.Spider):
	name = "rueducommerce_spider_new"
	def start_requests(self):
		urls = open("links.txt","r").read().split()
		...
		# urls={"https://www.rueducommerce.fr/rayon/ordinateurs-64/ordinateur-portable-657?page={}&sort=ventes&view=list":30,"https://www.rueducommerce.fr/rayon/ordinateurs-64/ordinateur-de-bureau-658?page={}&sort=ventes&view=list":232}

		
		# urls={"https://www.rueducommerce.fr/rayon/ordinateurs-64/ordinateur-portable-657?page={}&sort=ventes&view=list":2}
		
		# urls={"https://www.rueducommerce.fr/rayon/ordinateurs-64/ordinateur-portable-657?page={}&sort=ventes&view=list":1}
		# for url in urls:
		...
		for i in urls:
			yield scrapy.Request(url=i,callback=self.parse_details1,meta={"url":i,'category':'laptop', 'proxy':"http://scraperapi.country_code=fr:a6438ab03fee3e0af7053fbbcaa5c20c@proxy-server.scraperapi.com:8001"})


	def parse(self,response):
		for i in response.xpath("//article[@class='item']//a[@class='item__image']/@href").extract():
			url = "https://www.rueducommerce.fr"+i
			# print("--------------{}.............".format(url))

			# yield scrapy.Request(url)
			yield scrapy.Request(url=url,callback=self.parse_details1,meta={"url":url,'category':response.meta["category"], 'proxy':"http://scraperapi.country_code=fr:a6438ab03fee3e0af7053fbbcaa5c20c@proxy-server.scraperapi.com:8001"})

	# for url in urls:
	# 	yield scrapy.Request(url=url,callback=self.parse_details,meta={ 'category':'laptop','proxy':"http://scraperapi.country_code=fr:a6438ab03fee3e0af7053fbbcaa5c20c@proxy-server.scraperapi.com:8001"})
	...
	def parse_details(self,response):
		yield{
			...
			"battery":self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Autonomie")]//ancestor::p//following-sibling::p//span//text()""").getall()),
			"battery1":"".join(re.findall('<li>Autonomie (.*?)</li>',response.text))
		}
	...
	def parse_details1(self, response):
		...
		blkdata = " ".join(response.xpath("//div[@id='desc']//text()").getall()).strip().replace("\n"," "),
		...
		rm = [int(j) for j in self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Mémoire vive installée")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Mémoire")]//ancestor::p//following-sibling::p//span//text()""").getall()).split()]
		if(rm):
			rm = max(rm)
		else:
			rm = ""
		...
		yield{
				'competitor_list_price':"".join(response.xpath("//span[@class='dyn_prod_price product__price--new']//text() | //span[@class='dyn_prod_price']//text()").getall()).strip(),

				'competitor_markdown_price': "".join(response.xpath("//span[@class='dyn_prod_striked_price product__price--old']//text()").getall()).strip(),
				
			
				'competitor_product_id': self.sentize(response.xpath("""//meta[@itemprop='sku']/@content""").getall()),
				
				'competitor_product_name':response.xpath('//meta[@itemprop="name"]/@content').get(), 
				
				'competitor_model': '',
				'competitor_product_url':response.url,
				'competitor_laptop_type': response.meta["category"],
				...
				'competitor_screen_size':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Taille standard")]//ancestor::p//following-sibling::p//span//text() | li[@class="clr"]//p[@class="label"]//span[contains(string(),"Diagonale d'écran d'ordinateur")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Taille d'écran")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"d'écran")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_operating_system':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Version du Système d'exploitation")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Type de Système d'exploitation")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"d'exploitation")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_processor_series':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Modèle du processeur portable")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(translate(.,'ABCDEFGHIJKLMNOPQRSTUVWXYZ','abcdefghijklmnopqrstuvwxyz'),'processeur')]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_graphics':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"graphique")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_harddrive_capacity':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Capacité totale")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Capacité Disque Dur (HDD)")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Capacité Disque Dur")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				# 'competitor_ram_capacity':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Mémoire vive installée")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Mémoire")]//ancestor::p//following-sibling::p//span//text()""").getall()),


				'competitor_ram_capacity':rm,
				...
				'competitor_touchscreen':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Ecran tactile")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_display_resolution':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"pixels")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Résolution")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_optical_drive':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Lecteur/Graveur")]//ancestor::p//following-sibling::p//span//text() | //li[@class="clr"]//p[@class="label"]//span[contains(string(),"Lecteur")]//ancestor::p//following-sibling::p//span//text()""").getall()),
				...
				'competitor_keyboard_backlit':self.sentize(response.xpath("""//li[@class="clr"]//p[@class="label"]//span[contains(string(),"Rétroéclairage")]//ancestor::p//following-sibling::p//span//text()""").getall()),
